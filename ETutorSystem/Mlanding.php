        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <li><a href="#landing"><i class="fa fa-user s_color"></i> Management Portal</a></li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="login-box">
						<li class="search"><a href="#"><i class="fa fa-user-tie" onclick="document.getElementById('id02').style.display='block'" style="width:auto;"><p>Tutor</p></i></a>
                                        ...
                                        <div class="login-box">
						<li class="search"><a href="#"><i class="fa fa-users-cog" onclick="document.getElementById('id03').style.display='block'" style="width:auto;"><p>Admin</p></i></a>
